...
const sendMail_1 = require("../utils/email/sendMail");
...
let UserResolver = class UserResolver {
    ...
    changePassword(newPassword, confNewPassword, token, { redis }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield User_1.User.update({ id: userIdNum }, { password: newPasswordHash });
            redis.del(key);
            return { user };
        });
    }
    forgotPassword(email, { redis }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            redis.set(constants_1.FORGOT_PASSWORD_PREFIX + token, user.id, 'ex', 1000 * 60 * 60 * 24 * 2);
            const resetLink = `<a href="http://localhost:3000/change-password/${token}">click here</a>`;
            const body = `${resetLink}`;
            sendMail_1.sendEmail({
                html: body,
                to: user.email,
